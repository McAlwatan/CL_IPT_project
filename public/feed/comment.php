...
if ($postId <= 0 || $content === '') {
    header("Location: /CL_DEV/CampusLink/public/feed/index.php?error=empty_comment#post-$postId");
    exit;
}
...
header("Location: /CL_DEV/CampusLink/public/feed/index.php#post-$postId");
exit;